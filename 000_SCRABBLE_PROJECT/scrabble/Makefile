...
build/computer_player.o: computer_player.cpp computer_player.h build/.make place_result.h move.h exceptions.h computer_player.h tile_kind.h formatting.h player.h
	$(COMPILE) -c $< -o $@
